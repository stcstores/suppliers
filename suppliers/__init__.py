...
while supplier_id is None:
    ...
    if supplier_name == "list":
        ...
        try:
            supplier = [s for s in suppliers if s.value.lower() == supplier_name][0]
            supplier_id = supplier.id
            supplier_name = supplier.value
        except IndexError as e:
            print("Supplier not recognised.", file=sys.stderr)
...
context = Context({"product_ranges": product_ranges, "supplier": supplier_name})
